...
@Component({
  selector: 'app-seek-help-list',
  templateUrl: './seek-help-list.component.html',
  styleUrls: ['./seek-help-list.component.scss']
})
export class SeekHelpListComponent implements OnInit {
  ...
  public getData(): void {
    ...
    this.userService.getSeekHelp(condition).subscribe(data => {
